...
inBounds:function(JAG, pos){
    ...
    if(isWhite){ 
		...
		D.cD.currentX=Y-CH;
		D.cD.currentY=X-(CW/2);
	};

	///////////////////////////////
	// DEBUG SPOT AT CHARACTER FEET
	///////////////////////////////
...
/***********************************************************************************************/
// MIDDLEGROUND ITEM LAYERING (TYPE=LAYER) - $Char.layerItem($sceneItems, l); 
/***********************************************************************************************/
layerItem:function($sceneItems, l){
	///////////////////////////////
	...
	for(var i=0; i<l; i++){
		...
		///////////////////////////////////
		if(eD.type==='layer' || AuxChar){
		
			// ELEMENT SET TO NOT LAYER
			if(!eD.layer) return $(this);
